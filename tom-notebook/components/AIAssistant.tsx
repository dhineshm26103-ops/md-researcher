...
export const AIAssistant: React.FC<AIAssistantProps> = ({ isOpen, onClose, language, onUploadClick, activeTab, userProfile }) => {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      setMessages([{
        id: uuidv4(),
        role: 'model',
        text: `Command systems online. I am your **AI Lab Guide**, ${userProfile.name}. I can explain how to use the **${activeTab.toUpperCase()}** module or any other feature of TomNoteBook. How can I help you today?`,
        timestamp: Date.now()
      }]);
    }
  }, [isOpen]);
  ...
  const handleSendMessage = async (text?: string) => {
    ...
    try {
      const context = `User: ${userProfile.name}. Active Protocol: ${activeTab}. Signature: ${userProfile.name}. Language: ${language}. MISSION: You are the TomNoteBook Guide. Explain app features clearly.`;
                 ...
                 <div className="p-6 bg-white border-t border-gray-100">
                    <div className="relative flex items-center max-w-xl mx-auto">
                       <input 
                         ...
                         placeholder="Ask me how TomNoteBook works..."
