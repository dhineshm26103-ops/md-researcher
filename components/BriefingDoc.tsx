...
export const BriefingDoc: React.FC<BriefingDocProps> = ({ sources, status, content, onGenerate, settings }) => {
  ...
  const handleExportPDF = () => {
    ...
    triggerPDFExport("MDR_Intelligence_Briefing", "printing-briefing", () => setIsExporting(true), () => setIsExporting(false));
  };
  ...
  const handleExportWord = async () => {
    ...
    setShowExportMenu(false);
    setIsExporting(true);
    try { await exportBriefingToDOCX(content, "MD Researcher Briefing"); } finally { setIsExporting(false); }
  };
